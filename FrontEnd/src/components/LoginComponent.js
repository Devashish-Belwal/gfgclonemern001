...
export default function LoginComponent({ setIsLoggedIn }) {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await fetch('https://gfgclonemern001.onrender.com/api/auth/login', {
                method: 'POST',
                headers: {
            ...
            const cartResponse = await fetch(`https://gfgclonemern001.onrender.com/api/cart/${responseData.userId}`);
